...
//=========  (Wed Mar 18 13:11:53 2015) by ROOT version5.34/18
   ...
   cnv->Range(-10.625,-0.01863938,51.875,0.1247404);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.1147039);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.06365021);
   h_gammaD_1_cT->SetBinContent(2,0.02340179);
   h_gammaD_1_cT->SetBinContent(3,0.00868066);
   h_gammaD_1_cT->SetBinContent(4,0.003110843);
   h_gammaD_1_cT->SetBinContent(5,0.001156499);
   h_gammaD_1_cT->SetBinContent(6,0.0006732608);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.06372437);
   h_gammaD_2_cT->SetBinContent(2,0.02330216);
   h_gammaD_2_cT->SetBinContent(3,0.008648145);
   h_gammaD_2_cT->SetBinContent(4,0.003150845);
   h_gammaD_2_cT->SetBinContent(5,0.001174486);
