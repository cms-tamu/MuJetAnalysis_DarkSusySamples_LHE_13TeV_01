...
//=========  (Mon Mar 16 00:22:28 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.53125,-0.37276,2.59375,2.494625);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.293908);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.276472);
   h_gammaD_1_cT->SetBinContent(2,0.4674887);
   h_gammaD_1_cT->SetBinContent(3,0.1708103);
   h_gammaD_1_cT->SetBinContent(4,0.06240564);
   h_gammaD_1_cT->SetBinContent(5,0.02282335);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.274393);
   h_gammaD_2_cT->SetBinContent(2,0.4678784);
   h_gammaD_2_cT->SetBinContent(3,0.1708287);
   h_gammaD_2_cT->SetBinContent(4,0.06316081);
   h_gammaD_2_cT->SetBinContent(5,0.0237388);
   h_gammaD_2_cT->SetBinContent(6,0.01387071);
