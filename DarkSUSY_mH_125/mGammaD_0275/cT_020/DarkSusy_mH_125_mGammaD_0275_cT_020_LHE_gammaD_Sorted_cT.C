...
//=========  (Mon Mar 16 00:14:49 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.2125,-0.9333798,1.0375,6.246465);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(5.743876);
   ...
   h_gammaD_1_cT->SetBinContent(1,3.184518);
   h_gammaD_1_cT->SetBinContent(2,1.164939);
   h_gammaD_1_cT->SetBinContent(3,0.4377013);
   h_gammaD_1_cT->SetBinContent(4,0.1539536);
   h_gammaD_1_cT->SetBinContent(5,0.05888867);
   h_gammaD_1_cT->SetBinContent(6,0.03315633);
   ...
   h_gammaD_2_cT->SetBinContent(1,3.191042);
   h_gammaD_2_cT->SetBinContent(2,1.165188);
   h_gammaD_2_cT->SetBinContent(3,0.4276907);
   h_gammaD_2_cT->SetBinContent(4,0.1574511);
   h_gammaD_2_cT->SetBinContent(5,0.05862742);
   h_gammaD_2_cT->SetBinContent(6,0.03233314);
