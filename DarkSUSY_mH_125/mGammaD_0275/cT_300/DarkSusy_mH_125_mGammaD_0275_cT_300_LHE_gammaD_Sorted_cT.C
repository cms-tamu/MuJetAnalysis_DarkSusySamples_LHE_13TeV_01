...
//=========  (Mon Mar 16 00:45:59 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-3.1875,-0.06203719,15.5625,0.415172);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.3817674);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.2112909);
   h_gammaD_1_cT->SetBinContent(2,0.07820681);
   h_gammaD_1_cT->SetBinContent(3,0.02920694);
   h_gammaD_1_cT->SetBinContent(4,0.01039989);
   h_gammaD_1_cT->SetBinContent(5,0.004228755);
   h_gammaD_1_cT->SetBinContent(6,0.00227799);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.212093);
   h_gammaD_2_cT->SetBinContent(2,0.07816868);
   h_gammaD_2_cT->SetBinContent(3,0.02893551);
   h_gammaD_2_cT->SetBinContent(4,0.01033351);
   h_gammaD_2_cT->SetBinContent(5,0.003802664);
   h_gammaD_2_cT->SetBinContent(6,0.002438574);
