...
//=========  (Mon Mar 16 00:37:35 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.09322328,10.375,0.6238789);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5736818);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3170498);
   h_gammaD_1_cT->SetBinContent(2,0.1182881);
   h_gammaD_1_cT->SetBinContent(3,0.04271584);
   h_gammaD_1_cT->SetBinContent(4,0.0161954);
   h_gammaD_1_cT->SetBinContent(5,0.005750815);
   h_gammaD_1_cT->SetBinContent(6,0.003347301);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3187121);
   h_gammaD_2_cT->SetBinContent(2,0.1168735);
   h_gammaD_2_cT->SetBinContent(3,0.04294506);
   h_gammaD_2_cT->SetBinContent(4,0.0159636);
   h_gammaD_2_cT->SetBinContent(5,0.005505776);
   h_gammaD_2_cT->SetBinContent(6,0.003378974);
