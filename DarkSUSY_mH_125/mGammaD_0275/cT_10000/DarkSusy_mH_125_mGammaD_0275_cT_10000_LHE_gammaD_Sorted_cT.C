...
//=========  (Wed Mar 18 13:12:10 2015) by ROOT version5.34/18
   ...
   cnv->Range(-106.25,-0.001856672,518.75,0.01242542);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01142567);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.006374365);
   h_gammaD_1_cT->SetBinContent(2,0.002349655);
   h_gammaD_1_cT->SetBinContent(3,0.0008390368);
   h_gammaD_1_cT->SetBinContent(4,0.0003235871);
   h_gammaD_1_cT->SetBinContent(5,0.0001133561);
   h_gammaD_1_cT->SetBinContent(6,6.479291e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006347596);
   h_gammaD_2_cT->SetBinContent(2,0.002364964);
   h_gammaD_2_cT->SetBinContent(3,0.0008614397);
   h_gammaD_2_cT->SetBinContent(4,0.0003058142);
   h_gammaD_2_cT->SetBinContent(5,0.0001201863);
   h_gammaD_2_cT->SetBinContent(6,6.783287e-05);
