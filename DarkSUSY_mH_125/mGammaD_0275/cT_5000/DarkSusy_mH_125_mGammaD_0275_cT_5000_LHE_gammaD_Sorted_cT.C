...
//=========  (Wed Mar 18 13:11:59 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-53.125,-0.003707105,259.375,0.02480909);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.02281296);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.01270215);
   h_gammaD_1_cT->SetBinContent(2,0.004717653);
   h_gammaD_1_cT->SetBinContent(3,0.001725922);
   h_gammaD_1_cT->SetBinContent(4,0.0006186839);
   h_gammaD_1_cT->SetBinContent(5,0.0002355932);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.01267387);
   h_gammaD_2_cT->SetBinContent(2,0.004690276);
   h_gammaD_2_cT->SetBinContent(3,0.001745828);
   h_gammaD_2_cT->SetBinContent(4,0.0006589645);
   h_gammaD_2_cT->SetBinContent(5,0.0002310655);
