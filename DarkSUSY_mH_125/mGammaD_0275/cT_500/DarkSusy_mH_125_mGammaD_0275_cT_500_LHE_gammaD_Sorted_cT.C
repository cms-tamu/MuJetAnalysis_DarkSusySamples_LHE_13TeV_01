...
//=========  (Mon Mar 16 00:53:39 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-5.3125,-0.03711681,25.9375,0.2483972);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2284112);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1280938);
   h_gammaD_1_cT->SetBinContent(2,0.04626482);
   h_gammaD_1_cT->SetBinContent(3,0.01705063);
   h_gammaD_1_cT->SetBinContent(4,0.006410353);
   h_gammaD_1_cT->SetBinContent(5,0.002180427);
   h_gammaD_1_cT->SetBinContent(6,0.001422565);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1268951);
   h_gammaD_2_cT->SetBinContent(2,0.04712872);
   h_gammaD_2_cT->SetBinContent(3,0.01731578);
   h_gammaD_2_cT->SetBinContent(4,0.006266207);
   h_gammaD_2_cT->SetBinContent(5,0.0023942);
   h_gammaD_2_cT->SetBinContent(6,0.001402281);
