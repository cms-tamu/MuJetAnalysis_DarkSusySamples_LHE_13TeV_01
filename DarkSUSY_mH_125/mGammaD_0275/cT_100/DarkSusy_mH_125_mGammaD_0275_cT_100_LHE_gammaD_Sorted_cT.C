...
//=========  (Mon Mar 16 00:30:05 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-1.0625,-0.1860393,5.1875,1.245032);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.144857);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.6375409);
   h_gammaD_1_cT->SetBinContent(2,0.2350239);
   h_gammaD_1_cT->SetBinContent(3,0.08514976);
   h_gammaD_1_cT->SetBinContent(4,0.03092122);
   h_gammaD_1_cT->SetBinContent(5,0.01136421);
   h_gammaD_1_cT->SetBinContent(6,0.006783287);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.6360317);
   h_gammaD_2_cT->SetBinContent(2,0.2345587);
   h_gammaD_2_cT->SetBinContent(3,0.08589953);
   h_gammaD_2_cT->SetBinContent(4,0.03144908);
   h_gammaD_2_cT->SetBinContent(5,0.01206093);
   h_gammaD_2_cT->SetBinContent(6,0.00716354);
