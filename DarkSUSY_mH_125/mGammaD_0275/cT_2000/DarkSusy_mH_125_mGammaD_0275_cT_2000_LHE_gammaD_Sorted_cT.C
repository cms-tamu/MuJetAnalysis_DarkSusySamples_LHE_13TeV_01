...
//=========  (Wed Mar 18 13:11:30 2015) by ROOT version5.34/18
   ...
   cnv->Range(-21.25,-0.009319735,103.75,0.06237054);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.05735222);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.03183077);
   h_gammaD_1_cT->SetBinContent(2,0.01165099);
   h_gammaD_1_cT->SetBinContent(3,0.004316954);
   h_gammaD_1_cT->SetBinContent(4,0.001614609);
   h_gammaD_1_cT->SetBinContent(5,0.0005866727);
   h_gammaD_1_cT->SetBinContent(6,0.000357543);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.03186234);
   h_gammaD_2_cT->SetBinContent(2,0.01163241);
   h_gammaD_2_cT->SetBinContent(3,0.004272014);
   h_gammaD_2_cT->SetBinContent(4,0.001646761);
   h_gammaD_2_cT->SetBinContent(5,0.000586466);
   h_gammaD_2_cT->SetBinContent(6,0.0003397979);
