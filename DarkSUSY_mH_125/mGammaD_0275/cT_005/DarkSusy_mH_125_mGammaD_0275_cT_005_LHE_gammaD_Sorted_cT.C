...
//=========  (Sun Mar 15 23:58:37 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.053125,-3.722098,0.259375,24.90942);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(22.90522);
   ...
   h_gammaD_1_cT->SetBinContent(1,12.66934);
   h_gammaD_1_cT->SetBinContent(2,4.705394);
   h_gammaD_1_cT->SetBinContent(3,1.752782);
   h_gammaD_1_cT->SetBinContent(4,0.6441054);
   h_gammaD_1_cT->SetBinContent(5,0.2283829);
   h_gammaD_1_cT->SetBinContent(6,0.143778);
   ...
   h_gammaD_2_cT->SetBinContent(1,12.72512);
   h_gammaD_2_cT->SetBinContent(2,4.690522);
   h_gammaD_2_cT->SetBinContent(3,1.7292);
   h_gammaD_2_cT->SetBinContent(4,0.620971);
   h_gammaD_2_cT->SetBinContent(5,0.2341861);
   h_gammaD_2_cT->SetBinContent(6,0.1447925);
