...
//=========  (Mon Mar 16 00:06:32 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.10625,-1.877613,0.51875,12.56556);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(11.55454);
   ...
   h_gammaD_1_cT->SetBinContent(1,6.347761);
   h_gammaD_1_cT->SetBinContent(2,2.350403);
   h_gammaD_1_cT->SetBinContent(3,0.8641168);
   h_gammaD_1_cT->SetBinContent(4,0.3164318);
   h_gammaD_1_cT->SetBinContent(5,0.1212884);
   h_gammaD_1_cT->SetBinContent(6,0.06529944);
   ...
   h_gammaD_2_cT->SetBinContent(1,6.419189);
   h_gammaD_2_cT->SetBinContent(2,2.298508);
   h_gammaD_2_cT->SetBinContent(3,0.8567978);
   h_gammaD_2_cT->SetBinContent(4,0.3165497);
   h_gammaD_2_cT->SetBinContent(5,0.1089555);
