...
//=========  (Mon Mar 16 01:24:46 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.53125,-0.3747845,2.59375,2.508173);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.306366);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.273855);
   h_gammaD_1_cT->SetBinContent(2,0.4705335);
   h_gammaD_1_cT->SetBinContent(3,0.1711626);
   h_gammaD_1_cT->SetBinContent(4,0.06129844);
   h_gammaD_1_cT->SetBinContent(5,0.02315048);
   h_gammaD_1_cT->SetBinContent(6,0.01305989);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.281314);
   h_gammaD_2_cT->SetBinContent(2,0.4610991);
   h_gammaD_2_cT->SetBinContent(3,0.1702229);
   h_gammaD_2_cT->SetBinContent(4,0.06371094);
   h_gammaD_2_cT->SetBinContent(5,0.02365256);
   h_gammaD_2_cT->SetBinContent(6,0.01295858);
