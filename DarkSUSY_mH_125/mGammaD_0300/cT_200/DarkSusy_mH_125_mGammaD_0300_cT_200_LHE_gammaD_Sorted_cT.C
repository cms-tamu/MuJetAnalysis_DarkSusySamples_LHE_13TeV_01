...
//=========  (Mon Mar 16 01:39:46 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.09321756,10.375,0.6238406);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5736465);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.3165867);
   h_gammaD_1_cT->SetBinContent(2,0.1179939);
   h_gammaD_1_cT->SetBinContent(3,0.04332968);
   h_gammaD_1_cT->SetBinContent(4,0.01603545);
   h_gammaD_1_cT->SetBinContent(5,0.006054198);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3186925);
   h_gammaD_2_cT->SetBinContent(2,0.1166065);
   h_gammaD_2_cT->SetBinContent(3,0.04319271);
   h_gammaD_2_cT->SetBinContent(4,0.01583397);
   h_gammaD_2_cT->SetBinContent(5,0.005674312);
   h_gammaD_2_cT->SetBinContent(6,0.00325864);
