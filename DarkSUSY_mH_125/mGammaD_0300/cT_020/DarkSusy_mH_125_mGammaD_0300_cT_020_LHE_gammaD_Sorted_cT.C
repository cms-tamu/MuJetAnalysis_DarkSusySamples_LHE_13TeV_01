...
//=========  (Mon Mar 16 01:17:12 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.2125,-0.930106,1.0375,6.224556);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(5.723729);
   ...
   h_gammaD_1_cT->SetBinContent(1,3.180423);
   h_gammaD_1_cT->SetBinContent(2,1.16794);
   h_gammaD_1_cT->SetBinContent(3,0.4357674);
   h_gammaD_1_cT->SetBinContent(4,0.1579861);
   h_gammaD_1_cT->SetBinContent(5,0.05788421);
   h_gammaD_1_cT->SetBinContent(6,0.03334634);
   ...
   h_gammaD_2_cT->SetBinContent(1,3.17985);
   h_gammaD_2_cT->SetBinContent(2,1.165699);
   h_gammaD_2_cT->SetBinContent(3,0.4308033);
   h_gammaD_2_cT->SetBinContent(4,0.1633452);
   h_gammaD_2_cT->SetBinContent(5,0.06030239);
   h_gammaD_2_cT->SetBinContent(6,0.03562751);
