...
//=========  (Mon Mar 16 01:48:01 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-3.1875,-0.06181358,15.5625,0.4136755);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.3803913);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.2117585);
   h_gammaD_1_cT->SetBinContent(2,0.07849232);
   h_gammaD_1_cT->SetBinContent(3,0.02891602);
   h_gammaD_1_cT->SetBinContent(4,0.01046229);
   h_gammaD_1_cT->SetBinContent(5,0.00370417);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.2113285);
   h_gammaD_2_cT->SetBinContent(2,0.07800186);
   h_gammaD_2_cT->SetBinContent(3,0.02937029);
   h_gammaD_2_cT->SetBinContent(4,0.01075106);
   h_gammaD_2_cT->SetBinContent(5,0.003881629);
   h_gammaD_2_cT->SetBinContent(6,0.002370941);
