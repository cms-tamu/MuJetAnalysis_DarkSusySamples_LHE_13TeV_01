...
//=========  (Wed Mar 18 13:12:14 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-21.25,-0.00934152,103.75,0.06251633);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.05748628);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.0319515);
   h_gammaD_1_cT->SetBinContent(2,0.01165229);
   h_gammaD_1_cT->SetBinContent(3,0.004256175);
   h_gammaD_1_cT->SetBinContent(4,0.001545756);
   h_gammaD_1_cT->SetBinContent(5,0.0005942798);
   h_gammaD_1_cT->SetBinContent(6,0.0003087739);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.03193682);
   h_gammaD_2_cT->SetBinContent(2,0.01159388);
   h_gammaD_2_cT->SetBinContent(3,0.004297131);
   h_gammaD_2_cT->SetBinContent(4,0.001565568);
   h_gammaD_2_cT->SetBinContent(5,0.0006065945);
