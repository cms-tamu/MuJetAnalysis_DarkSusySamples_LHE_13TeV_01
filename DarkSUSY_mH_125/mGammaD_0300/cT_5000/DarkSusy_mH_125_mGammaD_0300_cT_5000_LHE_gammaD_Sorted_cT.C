...
//=========  (Wed Mar 18 13:13:09 2015) by ROOT version5.34/18
   ...
   cnv->Range(-53.125,-0.003726997,259.375,0.02494221);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.02293537);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.01267054);
   h_gammaD_1_cT->SetBinContent(2,0.004719288);
   h_gammaD_1_cT->SetBinContent(3,0.001748667);
   h_gammaD_1_cT->SetBinContent(4,0.0006303451);
   h_gammaD_1_cT->SetBinContent(5,0.0002311601);
   h_gammaD_1_cT->SetBinContent(6,0.0001224972);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.01274187);
   h_gammaD_2_cT->SetBinContent(2,0.004643109);
   h_gammaD_2_cT->SetBinContent(3,0.001748968);
   h_gammaD_2_cT->SetBinContent(4,0.0006350045);
   h_gammaD_2_cT->SetBinContent(5,0.000231048);
   h_gammaD_2_cT->SetBinContent(6,0.0001346522);
