...
//=========  (Mon Mar 16 01:32:15 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-1.0625,-0.186894,5.1875,1.250752);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.150117);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.6378735);
   h_gammaD_1_cT->SetBinContent(2,0.2330861);
   h_gammaD_1_cT->SetBinContent(3,0.08568694);
   h_gammaD_1_cT->SetBinContent(4,0.03197049);
   h_gammaD_1_cT->SetBinContent(5,0.01138295);
   h_gammaD_1_cT->SetBinContent(6,0.007328406);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.6389539);
   h_gammaD_2_cT->SetBinContent(2,0.2314934);
   h_gammaD_2_cT->SetBinContent(3,0.08534069);
   h_gammaD_2_cT->SetBinContent(4,0.03204209);
   h_gammaD_2_cT->SetBinContent(5,0.01216995);
