...
//=========  (Mon Mar 16 01:08:47 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.10625,-1.848986,0.51875,12.37398);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(11.37838);
   ...
   h_gammaD_1_cT->SetBinContent(1,6.348293);
   h_gammaD_1_cT->SetBinContent(2,2.341296);
   h_gammaD_1_cT->SetBinContent(3,0.8777185);
   h_gammaD_1_cT->SetBinContent(4,0.316905);
   h_gammaD_1_cT->SetBinContent(5,0.1157874);
   h_gammaD_1_cT->SetBinContent(6,0.06833971);
   ...
   h_gammaD_2_cT->SetBinContent(1,6.32132);
   h_gammaD_2_cT->SetBinContent(2,2.382654);
   h_gammaD_2_cT->SetBinContent(3,0.8562152);
   h_gammaD_2_cT->SetBinContent(4,0.3241638);
   h_gammaD_2_cT->SetBinContent(5,0.1156469);
   h_gammaD_2_cT->SetBinContent(6,0.06707271);
