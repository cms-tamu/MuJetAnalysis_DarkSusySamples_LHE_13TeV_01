...
//=========  (Mon Mar 16 01:55:30 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-5.3125,-0.03729329,25.9375,0.2495782);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.2294972);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1268344);
   h_gammaD_1_cT->SetBinContent(2,0.04696674);
   h_gammaD_1_cT->SetBinContent(3,0.01734513);
   h_gammaD_1_cT->SetBinContent(4,0.006563566);
   h_gammaD_1_cT->SetBinContent(5,0.002290201);
   h_gammaD_1_cT->SetBinContent(6,0.001333853);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1274984);
   h_gammaD_2_cT->SetBinContent(2,0.04671786);
   h_gammaD_2_cT->SetBinContent(3,0.0172076);
   h_gammaD_2_cT->SetBinContent(4,0.00633262);
   h_gammaD_2_cT->SetBinContent(5,0.002243485);
   h_gammaD_2_cT->SetBinContent(6,0.001432708);
