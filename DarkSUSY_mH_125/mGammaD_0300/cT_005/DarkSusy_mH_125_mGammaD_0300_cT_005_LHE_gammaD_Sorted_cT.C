...
//=========  (Mon Mar 16 01:01:10 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.053125,-3.727191,0.259375,24.94351);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(22.93656);
   ...
   h_gammaD_1_cT->SetBinContent(1,12.73084);
   h_gammaD_1_cT->SetBinContent(2,4.68407);
   h_gammaD_1_cT->SetBinContent(3,1.721629);
   h_gammaD_1_cT->SetBinContent(4,0.6464606);
   h_gammaD_1_cT->SetBinContent(5,0.2169973);
   h_gammaD_1_cT->SetBinContent(6,0.1387071);
   ...
   h_gammaD_2_cT->SetBinContent(1,12.74253);
   h_gammaD_2_cT->SetBinContent(2,4.69728);
   h_gammaD_2_cT->SetBinContent(3,1.704693);
   h_gammaD_2_cT->SetBinContent(4,0.6259517);
   h_gammaD_2_cT->SetBinContent(5,0.2295408);
   h_gammaD_2_cT->SetBinContent(6,0.1349055);
