...
//=========  (Wed Mar 18 13:13:04 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",1320,22,904,928);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-106.25,-0.001865137,518.75,0.01248207);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01147777);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.006354788);
   h_gammaD_1_cT->SetBinContent(2,0.002343179);
   h_gammaD_1_cT->SetBinContent(3,0.0008755761);
   h_gammaD_1_cT->SetBinContent(4,0.000310997);
   h_gammaD_1_cT->SetBinContent(5,0.0001154592);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006376538);
   h_gammaD_2_cT->SetBinContent(2,0.002331849);
   h_gammaD_2_cT->SetBinContent(3,0.0008672404);
   h_gammaD_2_cT->SetBinContent(4,0.0003087491);
   h_gammaD_2_cT->SetBinContent(5,0.0001156237);
   h_gammaD_2_cT->SetBinContent(6,6.504617e-05);
