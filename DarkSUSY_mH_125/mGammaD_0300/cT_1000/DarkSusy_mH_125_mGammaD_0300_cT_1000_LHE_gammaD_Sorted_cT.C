...
//=========  (Wed Mar 18 13:12:28 2015) by ROOT version5.34/18
   ...
   cnv->Range(-10.625,-0.01859525,51.875,0.1244452);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.1144323);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.0633335);
   h_gammaD_1_cT->SetBinContent(2,0.02358346);
   h_gammaD_1_cT->SetBinContent(3,0.008640219);
   h_gammaD_1_cT->SetBinContent(4,0.003288695);
   h_gammaD_1_cT->SetBinContent(5,0.001154127);
   h_gammaD_1_cT->SetBinContent(6,0.0006859315);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.06357352);
   h_gammaD_2_cT->SetBinContent(2,0.02341009);
   h_gammaD_2_cT->SetBinContent(3,0.008671292);
   h_gammaD_2_cT->SetBinContent(4,0.003198066);
   h_gammaD_2_cT->SetBinContent(5,0.001147023);
   h_gammaD_2_cT->SetBinContent(6,0.0007252307);
