...
//=========  (Sun Mar 15 23:42:50 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-3.1875,-0.06194618,15.5625,0.4145629);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.3812073);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.2126521);
   h_gammaD_1_cT->SetBinContent(2,0.07748133);
   h_gammaD_1_cT->SetBinContent(3,0.02891182);
   h_gammaD_1_cT->SetBinContent(4,0.0107014);
   h_gammaD_1_cT->SetBinContent(5,0.00358671);
   h_gammaD_1_cT->SetBinContent(6,0.002261096);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.2117818);
   h_gammaD_2_cT->SetBinContent(2,0.07796108);
   h_gammaD_2_cT->SetBinContent(3,0.02903092);
   h_gammaD_2_cT->SetBinContent(4,0.01079274);
   h_gammaD_2_cT->SetBinContent(5,0.003766763);
   h_gammaD_2_cT->SetBinContent(6,0.002231534);
