...
//=========  (Sun Mar 15 23:25:51 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-1.0625,-0.1865974,5.1875,1.248767);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(1.148291);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.6367046);
   h_gammaD_1_cT->SetBinContent(2,0.2305368);
   h_gammaD_1_cT->SetBinContent(3,0.08860218);
   h_gammaD_1_cT->SetBinContent(4,0.0324753);
   h_gammaD_1_cT->SetBinContent(5,0.01168104);
   h_gammaD_1_cT->SetBinContent(6,0.006973378);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.6379397);
   h_gammaD_2_cT->SetBinContent(2,0.2347265);
   h_gammaD_2_cT->SetBinContent(3,0.08429369);
   h_gammaD_2_cT->SetBinContent(4,0.03172966);
   h_gammaD_2_cT->SetBinContent(5,0.01131045);
   h_gammaD_2_cT->SetBinContent(6,0.006479291);
