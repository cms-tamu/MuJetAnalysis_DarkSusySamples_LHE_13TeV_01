...
//=========  (Sun Mar 15 23:50:43 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-5.3125,-0.03728448,25.9375,0.2495192);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.229443);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.1271055);
   h_gammaD_1_cT->SetBinContent(2,0.0472283);
   h_gammaD_1_cT->SetBinContent(3,0.01709569);
   h_gammaD_1_cT->SetBinContent(4,0.006260537);
   h_gammaD_1_cT->SetBinContent(5,0.002309957);
   h_gammaD_1_cT->SetBinContent(6,0.001300924);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.1274683);
   h_gammaD_2_cT->SetBinContent(2,0.04707022);
   h_gammaD_2_cT->SetBinContent(3,0.01710935);
   h_gammaD_2_cT->SetBinContent(4,0.006230733);
   h_gammaD_2_cT->SetBinContent(5,0.002121368);
   h_gammaD_2_cT->SetBinContent(6,0.001313588);
