...
//=========  (Sun Mar 15 23:33:40 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-2.125,-0.09307002,10.375,0.6228532);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.5727386);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.315663);
   h_gammaD_1_cT->SetBinContent(2,0.1195611);
   h_gammaD_1_cT->SetBinContent(3,0.04330347);
   h_gammaD_1_cT->SetBinContent(4,0.01561517);
   h_gammaD_1_cT->SetBinContent(5,0.005857261);
   h_gammaD_1_cT->SetBinContent(6,0.003302967);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.3181881);
   h_gammaD_2_cT->SetBinContent(2,0.1164651);
   h_gammaD_2_cT->SetBinContent(3,0.0437806);
   h_gammaD_2_cT->SetBinContent(4,0.01572628);
   h_gammaD_2_cT->SetBinContent(5,0.00583993);
   h_gammaD_2_cT->SetBinContent(6,0.003435994);
