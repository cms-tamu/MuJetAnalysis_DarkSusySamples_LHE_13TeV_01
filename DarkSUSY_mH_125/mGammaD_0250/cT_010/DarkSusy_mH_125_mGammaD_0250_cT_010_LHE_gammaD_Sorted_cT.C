...
//=========  (Sun Mar 15 23:01:28 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.10625,-1.864627,0.51875,12.47866);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(11.47463);
   ...
   h_gammaD_1_cT->SetBinContent(1,6.368214);
   h_gammaD_1_cT->SetBinContent(2,2.335205);
   h_gammaD_1_cT->SetBinContent(3,0.8713113);
   h_gammaD_1_cT->SetBinContent(4,0.3099506);
   h_gammaD_1_cT->SetBinContent(5,0.1153188);
   h_gammaD_1_cT->SetBinContent(6,0.07138181);
   ...
   h_gammaD_2_cT->SetBinContent(1,6.374794);
   h_gammaD_2_cT->SetBinContent(2,2.3435);
   h_gammaD_2_cT->SetBinContent(3,0.8511977);
   h_gammaD_2_cT->SetBinContent(4,0.3187271);
   h_gammaD_2_cT->SetBinContent(5,0.1117811);
   h_gammaD_2_cT->SetBinContent(6,0.07024081);
