...
//=========  (Sun Mar 15 23:17:53 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.53125,-0.3716992,2.59375,2.487525);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(2.28738);
   ...
   h_gammaD_1_cT->SetBinContent(1,1.271997);
   h_gammaD_1_cT->SetBinContent(2,0.467608);
   h_gammaD_1_cT->SetBinContent(3,0.1738901);
   h_gammaD_1_cT->SetBinContent(4,0.06345011);
   h_gammaD_1_cT->SetBinContent(5,0.02305447);
   h_gammaD_1_cT->SetBinContent(6,0.01346522);
   ...
   h_gammaD_2_cT->SetBinContent(1,1.270766);
   h_gammaD_2_cT->SetBinContent(2,0.475342);
   h_gammaD_2_cT->SetBinContent(3,0.1685228);
   h_gammaD_2_cT->SetBinContent(4,0.06171115);
   h_gammaD_2_cT->SetBinContent(5,0.02365762);
   h_gammaD_2_cT->SetBinContent(6,0.01338921);
