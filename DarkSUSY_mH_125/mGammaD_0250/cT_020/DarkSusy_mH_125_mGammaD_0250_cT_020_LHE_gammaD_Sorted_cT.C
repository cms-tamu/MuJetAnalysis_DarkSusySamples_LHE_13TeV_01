...
//=========  (Sun Mar 15 23:09:51 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.2125,-0.9332628,1.0375,6.245682);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(5.743156);
   ...
   h_gammaD_1_cT->SetBinContent(1,3.20995);
   h_gammaD_1_cT->SetBinContent(2,1.158297);
   h_gammaD_1_cT->SetBinContent(3,0.4176216);
   h_gammaD_1_cT->SetBinContent(4,0.1588511);
   h_gammaD_1_cT->SetBinContent(5,0.05527993);
   h_gammaD_1_cT->SetBinContent(6,0.0368323);
   ...
   h_gammaD_2_cT->SetBinContent(1,3.190642);
   h_gammaD_2_cT->SetBinContent(2,1.165706);
   h_gammaD_2_cT->SetBinContent(3,0.4283881);
   h_gammaD_2_cT->SetBinContent(4,0.1552514);
   h_gammaD_2_cT->SetBinContent(5,0.06001208);
   h_gammaD_2_cT->SetBinContent(6,0.03239646);
