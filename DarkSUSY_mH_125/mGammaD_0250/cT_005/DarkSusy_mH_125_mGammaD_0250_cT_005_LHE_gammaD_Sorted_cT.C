...
//=========  (Sun Mar 15 22:53:12 2015) by ROOT version5.34/18
   TCanvas *cnv = new TCanvas("cnv", "cnv",0,22,904,756);
   gStyle->SetOptFit(1);
   gStyle->SetOptStat(0);
   gStyle->SetOptTitle(0);
   cnv->SetHighLightColor(2);
   cnv->Range(-0.053125,-3.711034,0.259375,24.83538);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(22.83713);
   ...
   h_gammaD_1_cT->SetBinContent(1,12.70543);
   h_gammaD_1_cT->SetBinContent(2,4.692241);
   h_gammaD_1_cT->SetBinContent(3,1.729091);
   h_gammaD_1_cT->SetBinContent(4,0.6378023);
   h_gammaD_1_cT->SetBinContent(5,0.2354304);
   h_gammaD_1_cT->SetBinContent(6,0.1435244);
   ...
   h_gammaD_2_cT->SetBinContent(1,12.6873);
   h_gammaD_2_cT->SetBinContent(2,4.68327);
   h_gammaD_2_cT->SetBinContent(3,1.743396);
   h_gammaD_2_cT->SetBinContent(4,0.6445283);
   h_gammaD_2_cT->SetBinContent(5,0.2415094);
   h_gammaD_2_cT->SetBinContent(6,0.1255346);
