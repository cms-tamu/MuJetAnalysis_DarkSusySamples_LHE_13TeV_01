...
//=========  (Wed Mar 18 13:10:25 2015) by ROOT version5.34/18
   ...
   cnv->Range(-106.25,-0.001851987,518.75,0.01239407);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.01139684);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.006340165);
   h_gammaD_1_cT->SetBinContent(2,0.002365656);
   h_gammaD_1_cT->SetBinContent(3,0.0008568301);
   h_gammaD_1_cT->SetBinContent(4,0.0003217202);
   h_gammaD_1_cT->SetBinContent(5,0.000115628);
   h_gammaD_1_cT->SetBinContent(6,6.542609e-05);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.006331579);
   h_gammaD_2_cT->SetBinContent(2,0.002366175);
   h_gammaD_2_cT->SetBinContent(3,0.0008632541);
   h_gammaD_2_cT->SetBinContent(4,0.0003236731);
   h_gammaD_2_cT->SetBinContent(5,0.0001153188);
   h_gammaD_2_cT->SetBinContent(6,7.138181e-05);
