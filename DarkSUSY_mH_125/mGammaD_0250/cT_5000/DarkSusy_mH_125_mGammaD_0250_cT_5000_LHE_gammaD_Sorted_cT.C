...
//=========  (Wed Mar 18 13:10:12 2015) by ROOT version5.34/18
   ...
   cnv->Range(-53.125,-0.003721194,259.375,0.02490338);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.02289966);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.01274139);
   h_gammaD_1_cT->SetBinContent(2,0.004698806);
   h_gammaD_1_cT->SetBinContent(3,0.001692527);
   h_gammaD_1_cT->SetBinContent(4,0.0006397624);
   h_gammaD_1_cT->SetBinContent(5,0.0002275158);
   h_gammaD_1_cT->SetBinContent(6,0.0001338921);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.01272203);
   h_gammaD_2_cT->SetBinContent(2,0.004659148);
   h_gammaD_2_cT->SetBinContent(3,0.001750579);
   h_gammaD_2_cT->SetBinContent(4,0.0006356359);
   h_gammaD_2_cT->SetBinContent(5,0.000232605);
   h_gammaD_2_cT->SetBinContent(6,0.0001387071);
