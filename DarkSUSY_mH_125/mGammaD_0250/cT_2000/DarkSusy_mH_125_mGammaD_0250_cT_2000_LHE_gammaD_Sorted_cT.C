...
//=========  (Wed Mar 18 13:09:49 2015) by ROOT version5.34/18
   ...
   cnv->Range(-21.25,-0.009272339,103.75,0.06205335);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.05706055);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.03187764);
   h_gammaD_1_cT->SetBinContent(2,0.01156795);
   h_gammaD_1_cT->SetBinContent(3,0.004343173);
   h_gammaD_1_cT->SetBinContent(4,0.001652294);
   h_gammaD_1_cT->SetBinContent(5,0.0005589476);
   h_gammaD_1_cT->SetBinContent(6,0.0003550072);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.03170031);
   h_gammaD_2_cT->SetBinContent(2,0.01181707);
   h_gammaD_2_cT->SetBinContent(3,0.004309585);
   h_gammaD_2_cT->SetBinContent(4,0.001579762);
   h_gammaD_2_cT->SetBinContent(5,0.0005932758);
