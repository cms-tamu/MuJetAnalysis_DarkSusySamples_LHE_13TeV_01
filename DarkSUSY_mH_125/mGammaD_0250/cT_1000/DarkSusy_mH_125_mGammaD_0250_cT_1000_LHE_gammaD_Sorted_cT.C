...
//=========  (Wed Mar 18 13:09:51 2015) by ROOT version5.34/18
   ...
   cnv->Range(-10.625,-0.0186698,51.875,0.124944);
   cnv->SetFillColor(0);
   cnv->SetBorderMode(0);
   cnv->SetBorderSize(2);
   cnv->SetTickx(1);
   ...
   h_gammaD_1_cT_dummy->SetMaximum(0.1148911);
   ...
   h_gammaD_1_cT->SetBinContent(1,0.06350647);
   h_gammaD_1_cT->SetBinContent(2,0.02354474);
   h_gammaD_1_cT->SetBinContent(3,0.008455864);
   h_gammaD_1_cT->SetBinContent(4,0.00330077);
   h_gammaD_1_cT->SetBinContent(5,0.001192155);
   h_gammaD_1_cT->SetBinContent(6,0.0007087467);
   ...
   h_gammaD_2_cT->SetBinContent(1,0.06382837);
   h_gammaD_2_cT->SetBinContent(2,0.02325013);
   h_gammaD_2_cT->SetBinContent(3,0.008550139);
   h_gammaD_2_cT->SetBinContent(4,0.003170587);
   h_gammaD_2_cT->SetBinContent(5,0.00120077);
   h_gammaD_2_cT->SetBinContent(6,0.000692268);
